...
namespace DeepZoomMarked
{
    public class Reflected : INotifyPropertyChanged
    {
        ...
        internal static string PreviousPageName{ get{  return 
                    DynamicPropsMark.Previous.Split(new[] {@"/", @"?"}, StringSplitOptions.RemoveEmptyEntries).  //  @"\"
    ...
    public class DynamicPropsMark : Reflected
	{ 
		...
		public ObservableCollection<Reflected> Reflecteds = new ObservableCollection<Reflected>();
	...
	public class MainProps : INotifyPropertyChanged
	{
